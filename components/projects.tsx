...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      id: 2,
      title: "NepNews",
      description: "NepNews: A full-stack news platform with SEO optimization, real-time article updates, user authentication, admin dashboard for content management, and MongoDB integration.",
    ...
    },
    {
      ...
      description: "A Quiz App built with Java using Swing for the GUI and MySQL for the database. Users can register, log in, take quizzes, and see their scores. The app fetches questions from MySQL and stores user scores. It demonstrates JDBC integration and basic database operations-College Project",
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tags.map((tag, index) => (
                    <span key={index} className="px-3 py-1 text-xs rounded-full bg-mario-blue/20 text-mario-blue">
                      {tag}
                    </span>
                  ))}
                </div>
